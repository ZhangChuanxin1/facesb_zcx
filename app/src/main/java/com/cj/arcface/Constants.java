...
public class Constants {
    ...
    public static final String APP_ID = "8L8wWWuEXU8kCKpF1trac5yoWFgRYbxvEBbR7hgGAZmH";
    public static final String SDK_KEY = "DsszwWBkht26Sb35L3zaSumuqzRqJFaeqrAGXnqpd9Kw";
